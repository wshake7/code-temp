...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Result<Object>> handleBiz(BizException ex) {
        log.warn("[BIZ] code={} msg={} traceId={}", ex.getCode(), ex.getMessage(), MDC.get("traceId"));
    ...
    public ResponseEntity<Result<Object>> handleAuth(AuthException ex) {
        log.warn("[AUTH] code={} msg={} traceId={}", ex.getCode(), ex.getMessage(), MDC.get("traceId"));
        HttpStatus status =
    ...
    public ResponseEntity<Result<Object>> handleNotLogin(NotLoginException ex) {
        log.warn("[SA_TOKEN] notLogin type={} msg={} traceId={}", ex.getType(), ex.getMessage(), MDC.get("traceId"));
    ...
    public ResponseEntity<Result<Object>> handleNotRole(NotRoleException ex) {
        log.warn("[SA_TOKEN] notRole role={} traceId={}", ex.getRole(), MDC.get("traceId"));
    ...
    public ResponseEntity<Result<Object>> handleSaToken(SaTokenException ex) {
        log.warn("[SA_TOKEN] {} traceId={}", ex.getMessage(), MDC.get("traceId"));
    ...
    public ResponseEntity<Result<Object>> handleAny(Exception ex) {
        log.error("[UNEXPECTED] {} traceId={}", ex.getClass().getSimpleName(), MDC.get("traceId"), ex);
