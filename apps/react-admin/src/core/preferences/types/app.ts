...
import type {
    AccessModeType, AuthPageLayoutType, BreadcrumbStyleType,
    ContentCompactType, LayoutHeaderModeType, LayoutType,
    LoginExpiredModeType, NavigationStyleType,
    PageTransitionType, PreferencesButtonPositionType, SupportedLanguagesType, TabsStyleType,
} from "./layout.ts";
