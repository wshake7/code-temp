---
name: develop-grill
description: "Build a feature using Research > Grill > Plan > Grill > Implement > Review phases with validation gates."
...
使用 `/grilling` skill 进行访谈，遵循 [ASK.md](ASK.md) 中的问答约定。
